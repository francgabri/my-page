...
#recorriendo la lista de numeros y multiplicandola por 10
for numero in numeros:
    resultado=numero*10
    print(resultado)
#reccorriendo dos listas del mismo tamaño al mismo tiempo
...
#forma ineficiente de recorrer una lista con su indice
...
#todo lo anterior aplica para las tuplas y para conjuntos
